...
export class APIServiceClient {
  ...
  traceTransactionStructLogs(
    request: proto_api_api_pb.TraceTransactionStructLogsRequest,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: proto_api_api_pb.TraceTransactionStructLogsResponse) => void
  ): grpcWeb.ClientReadableStream<proto_api_api_pb.TraceTransactionStructLogsResponse>;
...
export class APIServicePromiseClient {
  ...
  traceTransactionStructLogs(
    request: proto_api_api_pb.TraceTransactionStructLogsRequest,
    metadata?: grpcWeb.Metadata
  ): Promise<proto_api_api_pb.TraceTransactionStructLogsResponse>;
