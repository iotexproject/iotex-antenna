 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.iotexapi.TraceTransactionStructLogsRequest,
 *   !proto.iotexapi.TraceTransactionStructLogsResponse>}
 */
const methodDescriptor_APIService_TraceTransactionStructLogs = new grpc.web.MethodDescriptor(
  '/iotexapi.APIService/TraceTransactionStructLogs',
  grpc.web.MethodType.UNARY,
  proto.iotexapi.TraceTransactionStructLogsRequest,
  proto.iotexapi.TraceTransactionStructLogsResponse,
  /**
   * @param {!proto.iotexapi.TraceTransactionStructLogsRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.iotexapi.TraceTransactionStructLogsResponse.deserializeBinary
);
 ...
 *   !proto.iotexapi.TraceTransactionStructLogsResponse>}
 */
const methodInfo_APIService_TraceTransactionStructLogs = new grpc.web.AbstractClientBase.MethodInfo(
  proto.iotexapi.TraceTransactionStructLogsResponse,
  /**
   * @param {!proto.iotexapi.TraceTransactionStructLogsRequest} request
   * @return {!Uint8Array}
...
/**
 * @param {!proto.iotexapi.TraceTransactionStructLogsRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.Error, ?proto.iotexapi.TraceTransactionStructLogsResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.iotexapi.TraceTransactionStructLogsResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.iotexapi.APIServiceClient.prototype.traceTransactionStructLogs =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/iotexapi.APIService/TraceTransactionStructLogs',
      request,
      metadata || {},
      methodDescriptor_APIService_TraceTransactionStructLogs,
      callback);
};
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.iotexapi.TraceTransactionStructLogsResponse>}
 *     Promise that resolves to the response
 */
proto.iotexapi.APIServicePromiseClient.prototype.traceTransactionStructLogs =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/iotexapi.APIService/TraceTransactionStructLogs',
      request,
