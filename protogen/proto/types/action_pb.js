 ...
 * @const
 */
proto.iotextypes.Receipt.repeatedFields_ = [7];
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.iotextypes.Receipt.toObject = function(includeInstance, msg) {
    var f, obj = {
      ...
      blkheight: jspb.Message.getFieldWithDefault(msg, 3, 0),
      acthash: msg.getActhash_asB64(),
      gasconsumed: jspb.Message.getFieldWithDefault(msg, 5, 0),
...
proto.iotextypes.Receipt.prototype.getLogsList = function() {
  return /** @type{!Array<!proto.iotextypes.Log>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.iotextypes.Log, 7));
};
...
proto.iotextypes.Receipt.prototype.addLogs = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 7, opt_value, proto.iotextypes.Log, opt_index);
};
