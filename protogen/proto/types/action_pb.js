...
goog.exportSymbol('proto.iotextypes.RlpTransaction', null, global);
 ...
 * @constructor
 */
proto.iotextypes.RlpTransaction = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.iotextypes.RlpTransaction, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.iotextypes.RlpTransaction.displayName = 'proto.iotextypes.RlpTransaction';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.iotextypes.RlpTransaction.prototype.toObject = function(opt_includeInstance) {
  return proto.iotextypes.RlpTransaction.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.iotextypes.RlpTransaction} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.iotextypes.RlpTransaction.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.iotextypes.RlpTransaction}
 */
proto.iotextypes.RlpTransaction.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.iotextypes.RlpTransaction;
  return proto.iotextypes.RlpTransaction.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.iotextypes.RlpTransaction} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.iotextypes.RlpTransaction}
 */
proto.iotextypes.RlpTransaction.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.iotextypes.RlpTransaction.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.iotextypes.RlpTransaction.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.iotextypes.RlpTransaction} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.iotextypes.RlpTransaction.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.iotextypes.RlpTransaction.prototype.getChainid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.iotextypes.RlpTransaction} returns this
 */
proto.iotextypes.RlpTransaction.prototype.setChainid = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.iotextypes.RlpTransaction.prototype.getData = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {string}
 */
proto.iotextypes.RlpTransaction.prototype.getData_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getData()));
};
 ...
 * @return {!Uint8Array}
 */
proto.iotextypes.RlpTransaction.prototype.getData_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getData()));
};
 ...
 * @return {!proto.iotextypes.RlpTransaction} returns this
 */
proto.iotextypes.RlpTransaction.prototype.setData = function(value) {
  return jspb.Message.setProto3BytesField(this, 2, value);
};
...
proto.iotextypes.ActionCore.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    rlptransaction: (f = msg.getRlptransaction()) && proto.iotextypes.RlpTransaction.toObject(includeInstance, f),
...
proto.iotextypes.ActionCore.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 10:
      ...
      break;
    case 11:
      var value = new proto.iotextypes.RlpTransaction;
      reader.readMessage(value,proto.iotextypes.RlpTransaction.deserializeBinaryFromReader);
...
proto.iotextypes.ActionCore.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getRlptransaction();
  if (f != null) {
    writer.writeMessage(
      11,
      f,
      proto.iotextypes.RlpTransaction.serializeBinaryToWriter
    );
  }
...
/**
 * optional RlpTransaction rlpTransaction = 11;
 * @return {?proto.iotextypes.RlpTransaction}
 */
proto.iotextypes.ActionCore.prototype.getRlptransaction = function() {
  return /** @type{?proto.iotextypes.RlpTransaction} */ (
    jspb.Message.getWrapperField(this, proto.iotextypes.RlpTransaction, 11));
};


/**
 * @param {?proto.iotextypes.RlpTransaction|undefined} value
 * @return {!proto.iotextypes.ActionCore} returns this
*/
proto.iotextypes.ActionCore.prototype.setRlptransaction = function(value) {
 ...
 * @return {!proto.iotextypes.ActionCore} returns this
 */
proto.iotextypes.ActionCore.prototype.clearRlptransaction = function() {
  return this.setRlptransaction(undefined);
};
 ...
 * @return {boolean}
 */
proto.iotextypes.ActionCore.prototype.hasRlptransaction = function() {
