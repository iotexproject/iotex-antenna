...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.iotextypes.Endorsement.prototype.toObject = function(
    opt_includeInstance
  ) {
 ...
 * @return {!proto.iotextypes.Endorsement}
 */
proto.iotextypes.Endorsement.deserializeBinaryFromReader = function(
  msg,
  reader
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.iotextypes.Endorsement.serializeBinaryToWriter = function(
  message,
  writer
) {
  var f = undefined;
...
proto.iotextypes.Endorsement.prototype.getTopic = function() {
  return /** @type {!proto.iotextypes.Endorsement.ConsensusVoteTopic} */ (jspb.Message.getFieldWithDefault(
    this,
    4,
    0
  ));
...
proto.iotextypes.EndorsementSet = function(opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.iotextypes.EndorsementSet.repeatedFields_,
    null
  );
};
goog.inherits(proto.iotextypes.EndorsementSet, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.iotextypes.EndorsementSet.displayName =
    "proto.iotextypes.EndorsementSet";
}
/**
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.iotextypes.EndorsementSet.prototype.toObject = function(
    opt_includeInstance
  ) {
  ...
  proto.iotextypes.EndorsementSet.toObject = function(includeInstance, msg) {
    var f,
      obj = {
        blockhash: msg.getBlockhash_asB64(),
        round: jspb.Message.getFieldWithDefault(msg, 2, 0),
        endorsementsList: jspb.Message.toObjectList(
          msg.getEndorsementsList(),
          proto.iotextypes.Endorsement.toObject,
          includeInstance
        )
      };
...
proto.iotextypes.EndorsementSet.deserializeBinary = function(bytes) {
  ...
  return proto.iotextypes.EndorsementSet.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.iotextypes.EndorsementSet}
 */
proto.iotextypes.EndorsementSet.deserializeBinaryFromReader = function(
  msg,
  reader
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 3:
        ...
        reader.readMessage(
          value,
          proto.iotextypes.Endorsement.deserializeBinaryFromReader
        );
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.iotextypes.EndorsementSet.serializeBinaryToWriter = function(
  message,
  writer
) {
  var f = undefined;
...
proto.iotextypes.EndorsementSet.prototype.getEndorsementsList = function() {
  return /** @type{!Array<!proto.iotextypes.Endorsement>} */ (jspb.Message.getRepeatedWrapperField(
    this,
    proto.iotextypes.Endorsement,
    3
  ));
};

/** @param {!Array<!proto.iotextypes.Endorsement>} value */
proto.iotextypes.EndorsementSet.prototype.setEndorsementsList = function(
  value
) {
 ...
 * @return {!proto.iotextypes.Endorsement}
 */
proto.iotextypes.EndorsementSet.prototype.addEndorsements = function(
  opt_value,
  opt_index
) {
