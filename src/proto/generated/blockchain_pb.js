...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.iotextypes.BlockHeader.prototype.toObject = function(
    opt_includeInstance
  ) {
  ...
  proto.iotextypes.BlockHeader.toObject = function(includeInstance, msg) {
    var f,
      obj = {
        core:
          (f = msg.getCore()) &&
          proto.iotextypes.BlockHeaderCore.toObject(includeInstance, f),
 ...
 * @return {!proto.iotextypes.BlockHeader}
 */
proto.iotextypes.BlockHeader.deserializeBinaryFromReader = function(
  msg,
  reader
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          proto.iotextypes.BlockHeaderCore.deserializeBinaryFromReader
        );
        msg.setCore(value);
        break;
      case 2:
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.iotextypes.BlockHeader.serializeBinaryToWriter = function(
  message,
  writer
) {
  var f = undefined;
...
proto.iotextypes.BlockHeader.prototype.getCore = function() {
  return /** @type{?proto.iotextypes.BlockHeaderCore} */ (jspb.Message.getWrapperField(
    this,
    proto.iotextypes.BlockHeaderCore,
    1
  ));
};
...
if (goog.DEBUG && !COMPILED) {
  proto.iotextypes.BlockHeaderCore.displayName =
    "proto.iotextypes.BlockHeaderCore";
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.iotextypes.BlockHeaderCore.prototype.toObject = function(
    opt_includeInstance
  ) {
...
proto.iotextypes.BlockHeaderCore.deserializeBinary = function(bytes) {
  ...
  return proto.iotextypes.BlockHeaderCore.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.iotextypes.BlockHeaderCore}
 */
proto.iotextypes.BlockHeaderCore.deserializeBinaryFromReader = function(
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.iotextypes.BlockHeaderCore.serializeBinaryToWriter = function(
  message,
  writer
) {
  var f = undefined;
...
proto.iotextypes.BlockHeaderCore.prototype.getTxroot_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getTxroot()));
};
...
proto.iotextypes.BlockHeaderCore.prototype.getTxroot_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getTxroot()));
};
...
/** @param {!(string|Uint8Array)} value */
proto.iotextypes.BlockHeaderCore.prototype.setDeltastatedigest = function(
  value
) {
...
proto.iotextypes.BlockHeaderCore.prototype.getReceiptroot_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getReceiptroot()));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.iotextypes.BlockFooter.prototype.toObject = function(
    opt_includeInstance
  ) {
  ...
  proto.iotextypes.BlockFooter.toObject = function(includeInstance, msg) {
    var f,
      obj = {
        ...
        endorsements:
          (f = msg.getEndorsements()) &&
          endorsement_pb.EndorsementSet.toObject(includeInstance, f)
      };
 ...
 * @return {!proto.iotextypes.BlockFooter}
 */
proto.iotextypes.BlockFooter.deserializeBinaryFromReader = function(
  msg,
  reader
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 2:
        ...
        reader.readMessage(
          value,
          endorsement_pb.EndorsementSet.deserializeBinaryFromReader
        );
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.iotextypes.BlockFooter.serializeBinaryToWriter = function(
  message,
  writer
) {
  var f = undefined;
...
proto.iotextypes.BlockFooter.prototype.getEndorsements = function() {
  return /** @type{?proto.iotextypes.EndorsementSet} */ (jspb.Message.getWrapperField(
    this,
    endorsement_pb.EndorsementSet,
    2
  ));
};
...
proto.iotextypes.Block = function(opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.iotextypes.Block.repeatedFields_,
    null
  );
};
  ...
  proto.iotextypes.Block.toObject = function(includeInstance, msg) {
    var f,
      obj = {
        header:
          (f = msg.getHeader()) &&
          proto.iotextypes.BlockHeader.toObject(includeInstance, f),
        ...
        footer:
          (f = msg.getFooter()) &&
          proto.iotextypes.BlockFooter.toObject(includeInstance, f)
      };
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          proto.iotextypes.BlockHeader.deserializeBinaryFromReader
        );
        msg.setHeader(value);
        break;
      case 2:
      ...
      case 3:
        ...
        reader.readMessage(
          value,
          proto.iotextypes.BlockFooter.deserializeBinaryFromReader
        );
        msg.setFooter(value);
        break;
      default:
...
proto.iotextypes.Block.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(2, f, action_pb.Action.serializeBinaryToWriter);
  }
  f = message.getFooter();
  if (f != null) {
    writer.writeMessage(
...
proto.iotextypes.Block.prototype.getHeader = function() {
  return /** @type{?proto.iotextypes.BlockHeader} */ (jspb.Message.getWrapperField(
    this,
    proto.iotextypes.BlockHeader,
    1
  ));
};
...
proto.iotextypes.Block.prototype.getFooter = function() {
  return /** @type{?proto.iotextypes.BlockFooter} */ (jspb.Message.getWrapperField(
    this,
    proto.iotextypes.BlockFooter,
    3
  ));
};
...
proto.iotextypes.Receipts = function(opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.iotextypes.Receipts.repeatedFields_,
    null
  );
};
...
proto.iotextypes.Receipts.prototype.getReceiptsList = function() {
  return /** @type{!Array<!proto.iotextypes.Receipt>} */ (jspb.Message.getRepeatedWrapperField(
    this,
    action_pb.Receipt,
    1
  ));
 ...
 */
proto.iotextypes.Receipts.prototype.addReceipts = function(
  opt_value,
  opt_index
) {
  return jspb.Message.addToRepeatedWrapperField(
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.iotextypes.EpochData.prototype.toObject = function(
    opt_includeInstance
  ) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.iotextypes.ChainMeta.prototype.toObject = function(
    opt_includeInstance
  ) {
  ...
  proto.iotextypes.ChainMeta.toObject = function(includeInstance, msg) {
    var f,
      obj = {
        ...
        epoch:
          (f = msg.getEpoch()) &&
          proto.iotextypes.EpochData.toObject(includeInstance, f)
      };
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 4:
        ...
        reader.readMessage(
          value,
          proto.iotextypes.EpochData.deserializeBinaryFromReader
        );
        msg.setEpoch(value);
        break;
      default:
...
proto.iotextypes.ChainMeta.prototype.getEpoch = function() {
  return /** @type{?proto.iotextypes.EpochData} */ (jspb.Message.getWrapperField(
    this,
    proto.iotextypes.EpochData,
    4
  ));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.iotextypes.BlockMeta.prototype.toObject = function(
    opt_includeInstance
  ) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.iotextypes.AccountMeta.prototype.toObject = function(
    opt_includeInstance
  ) {
 ...
 * @return {!proto.iotextypes.AccountMeta}
 */
proto.iotextypes.AccountMeta.deserializeBinaryFromReader = function(
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.iotextypes.AccountMeta.serializeBinaryToWriter = function(
  message,
  writer
) {
  var f = undefined;
