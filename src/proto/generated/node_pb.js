...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.iotextypes.ServerMeta.prototype.toObject = function(
    opt_includeInstance
  ) {
 ...
 * @return {!proto.iotextypes.ServerMeta}
 */
proto.iotextypes.ServerMeta.deserializeBinaryFromReader = function(
  msg,
  reader
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.iotextypes.ServerMeta.serializeBinaryToWriter = function(
  message,
  writer
) {
  var f = undefined;
