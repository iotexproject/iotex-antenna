...
goog.provide('proto.iotexapi.GetChainMetaResponse');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.iproto.ChainMeta');
...
proto.iotexapi.GetChainMetaResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    chainmeta: (f = msg.getChainmeta()) && proto.iproto.ChainMeta.toObject(includeInstance, f)
  };
...
proto.iotexapi.GetChainMetaResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.iproto.ChainMeta;
      reader.readMessage(value,proto.iproto.ChainMeta.deserializeBinaryFromReader);
...
proto.iotexapi.GetChainMetaResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.iproto.ChainMeta.serializeBinaryToWriter
    );
  }
};
...
proto.iotexapi.GetChainMetaResponse.prototype.getChainmeta = function() {
  return /** @type{?proto.iproto.ChainMeta} */ (
    jspb.Message.getWrapperField(this, proto.iproto.ChainMeta, 1));
};
