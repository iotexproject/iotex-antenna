...
test('transferPb serialization and deserialization', async t => {
  ...
  const expected = actionPb.TransferPb.deserializeBinary(expectedBytes);

  const tf = new actionPb.TransferPb();
