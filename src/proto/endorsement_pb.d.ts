...
export class EndorsementSet extends jspb.Message {
  ...
  static toObject(includeInstance: boolean, msg: EndorsementSet): EndorsementSet.AsObject;
  static serializeBinaryToWriter(message: EndorsementSet, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): EndorsementSet;
  static deserializeBinaryFromReader(message: EndorsementSet, reader: jspb.BinaryReader): EndorsementSet;
}

export namespace EndorsementSet {
  export type AsObject = {
    blockhash: {};
    round: number;
