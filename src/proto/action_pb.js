...
proto.iotextypes.ActionCore.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 11:
      ...
      reader.readMessage(value,proto.iotextypes.Vote.deserializeBinaryFromReader);
      msg.setVote(value);
      break;
    case 12:
...
proto.iotextypes.ActionCore.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      11,
      f,
      proto.iotextypes.Vote.serializeBinaryToWriter
    );
  }
...
proto.iotextypes.ActionCore.prototype.getVote = function() {
  return /** @type{?proto.iotextypes.Vote} */ (
    jspb.Message.getWrapperField(this, proto.iotextypes.Vote, 11));
};


/** @param {?proto.iotextypes.Vote|undefined} value */
proto.iotextypes.ActionCore.prototype.setVote = function(value) {
  jspb.Message.setOneofWrapperField(this, 11, proto.iotextypes.ActionCore.oneofGroups_[0], value);
};
